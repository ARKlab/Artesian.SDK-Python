...
class AuctionQueryParameters(_QueryParameters): 
    ...
    def __init__(self, ids: int, extractionRangeSelectionConfig: ExtractionRangeConfig, extractionRangeType: ExtractionRangeType, timezone: str, filterId: int) -> _QueryParameters:
