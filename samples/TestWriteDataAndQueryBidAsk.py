...
registered = mkdservice.readMarketDataRegistryByName(bidAsk.providerName, bidAsk.marketDataName)
if (registered is None):
    registered = mkdservice.registerMarketData(bidAsk)
    
bidAsk = MarketData.UpsertData(Artesian.MarketData.MarketDataIdentifier(bidAsk.providerName, bidAsk.marketDataName), 'UTC', 
  bidAsk={
      datetime(2020,1,1):
      {
