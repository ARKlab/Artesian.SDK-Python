...
registered = mkdservice.readMarketDataRegistryByName(auction.providerName, auction.marketDataName)
if (registered is None):
    registered = mkdservice.registerMarketData(auction)
    
auctionRows = MarketData.UpsertData(Artesian.MarketData.MarketDataIdentifier(auction.providerName, auction.marketDataName), 'UTC', 
  auctionRows={
